    ...
    class SineFilmizlesen : MainAPI() {
        ...
        override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
            // Kaynakta doğrulanan pagination:
            // Sayfa 1: /Yetiskin-filmleri
            // Sayfa 2: /Yetiskin-filmleri/sayfa-2
            // Aynı yapı diğer kategori URL'lerine de uygulanır.
            val pageUrl = if (page <= 1) {
                request.data.trimEnd('/')
            } else {
                "${request.data.trimEnd('/')}/sayfa-$page"
            }
